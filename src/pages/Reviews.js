...
const reviews = [
  ...
  date: "November 2025",
  rating: 3,
  text: "Overall, the flight was uneventful and typical for the route. Check-in was slow, but the Coral Lounge made the wait more comfortable. The crew provided water during the delay, and while snacks and drinks were available for purchase, I stuck with my own. Aside from flying past a large cloud, the flight passed quickly, giving time to relax and watch downloaded content before landing near Mumbai."
},
  {
  ...
  date: "October 2025",
  rating: 5,
  text: "Overall, the short Bangkok Airways flight was quick and straightforward. Airport check-in and security were fast, lounges offered decent food and snacks (especially popcorn!), and boarding was organized despite a slight delay. The plane was noticeably old, but the seats and service were adequate, with a timely lunch and drinks service. The flight itself felt very short, and before long, we were already descending into Suvarnabhumi."
},
  {
  ...
  date: "April 2025",
  rating: 3,
  text: "Overall, the flight had a mixed experience. Boarding was fast but chaotic, and while the IFE initially had issues, it eventually worked well with plenty of movies to choose from. The abundance of juice options and a solid six hours of sleep were definite highlights, though minor annoyances like outdated moving maps, lack of WiFi, and repeated ads for Rwanda detracted slightly. Meals were basic but sufficient, and the cabin lighting created a nice sunrise effect. While not the airline’s best offering, the flight was manageable, comfortable in parts, and got us safely to our destination despite earlier delays."
},
  {
  ...
  date: "December 2024",
  rating: 4,
  text: "Overall, the journey was mostly smooth despite a slight delay and very late baggage arrival. The lounge visit helped pass the time comfortably, and the food was enjoyable, scoring around 5–8/10. Even with the minor hiccups, the flight experience was pleasant and manageable."
},
  // ⭐⭐ TEMPLATE ⭐⭐
  // {
  //   airline: "",
