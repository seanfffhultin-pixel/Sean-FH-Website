...
const reviews = [
  {
    ...
    date: "January 2026",
    rating: 5,
    logo: "/images/Etihad-airways-logo.svg.png",
    images: [
      "/images/Screenshot 2026-02-12 at 22.47.59.png",
      "/images/Etihad_787_food.jpeg",
    ],
    story:
  ...
  {
    title: "Cathay Pacific Economy",
    slug: "cathay-pacific-economy-cx789-hkg-bkk",
    route: "CX789 HKG → BKK",
    ...
    date: "December 2025",
    rating: 5,
    logo: "/images/Cathay-Pacific-Logo.png",
    images: [
      "/images/Image (12).jpeg",
      "/images/IMG_4619.jpeg",
      "/images/Cathay_A330_food.jpeg",
      "/images/Cathay_winglet.png",
    ],
    story:
  ...
  {
    title: "Etihad Economy (Police Incident)",
    slug: "etihad-economy-police-incident-ey870-auh-hkg",
    route: "EY870 AUH → HKG",
    ...
    rating: 5,
    logo: "/images/Etihad-airways-logo.svg.png",
    images: ["/images/Screenshot 2026-02-11 at 22.26.44.png"],
    story:
  ...
  {
    title: "Etihad Economy",
    slug: "etihad-economy-ey58-bru-auh",
    route: "EY58 BRU → AUH",
  ...
  {
    title: "EasyJet Economy",
    slug: "easyjet-economy-u25707-sen-ams",
    route: "U25707 SEN → AMS",
    aircraft: "Airbus A320neo",
    flightTime: "1h 27m",
    seat: "9F",
    date: "December 2025",
    rating: 4,
    logo: "/images/EasyJet_logo.svg.png",
    images: ["/images/Image (10).jpeg"],
    story:
      "Southend Airport has always been special to me, being the smallest London airport it means the experience is super quick and efficient, though the shops airside were a little underwhelming I still was very impressed - it is now my favourite London Airport! This was one of the most exciting flights I've taken in a while, and it was a great way to kick off the trip. The flight was smooth and uneventful, but the highlight was the beauftiful view over the English channel and the incredible landing into the foggiest airport I've ever seen, literally under 20 meters visibility. The crew was friendly and efficient, and the overall experience was enjoyable, making it a memorable start to an exciting series of flights.",
  },

  {
    title: "IndiGo Economy",
    slug: "indigo-economy-6e1052-bkk-bom",
    route: "6E1052 BKK → BOM",
    aircraft: "Airbus A321neo",
    flightTime: "4h 26m",
    seat: "7F",
    date: "November 2025",
    rating: 3,
    logo: "/images/IndiGo_Airlines_logo.svg.png",
    images: ["/images/Image (15).jpeg"],
    story:
      "The flight was uneventful and typical for the route. Check-in was slow, but the Coral Lounge made the wait more comfortable. The crew provided water during the delay, and while snacks and drinks were available for purchase, I stuck with my own. Aside from flying past a large cloud, the flight passed quickly, giving time to relax and watch downloaded content before landing near Mumbai.",
  },

  {
    title: "Bangkok Airways Economy",
    slug: "bangkok-airways-economy-pg272-hkt-bkk",
    route: "PG272 HKT → BKK",
    ...
    date: "October 2025",
    rating: 5,
    logo: "/images/Bangkok_Airways_Logo.svg.png",
    images: ["/images/Image (14).jpeg"],
    story:
      "The short Bangkok Airways flight was quick and straightforward. Airport check-in and security were fast, lounges offered decent food and snacks (especially popcorn!), and boarding was organized despite a slight delay. The plane was noticeably old, but the seats and service were adequate, with a timely lunch and drinks service. The flight itself felt very short, and before long, we were already descending into Suvarnabhumi.",
  },

  {
    title: "IndiGo Economy (Norse Lease)",
    slug: "indigo-economy-norse-lease-6e22-ams-bom",
    route: "6E22 AMS → BOM",
    aircraft: "Boeing 787-9",
    flightTime: "8h 30m",
    seat: "39A",
...

  {
    ...
    date: "December 2024",
    rating: 5,
    logo: "/images/Logo-Saudia-.avif",
    images: ["/images/Image (2).jpeg"],
    story:
  ...
  {
    title: "British Airways Business",
    slug: "british-airways-business-ba326-lhr-cdg",
    route: "BA326 LHR → CDG",
    aircraft: "Airbus A321neo",
    flightTime: "1h 10m",
    seat: "1F",
    date: "December 2024",
    rating: 4,
    logo: "/images/British-Airways-Logo.png",
    images: [
      "/images/Image (9).jpeg",
      "/images/BA_biz_food.png",
    ],
    story:
      "The journey was mostly smooth despite a slight delay and very late baggage arrival. The lounge visit helped pass the time comfortably, and the food was enjoyable, scoring around 5–8/10. Even with the minor hiccups, the flight experience was pleasant and manageable.",
  },
];
